...
export const HEARTS_CONFIG = {
  initial: 5,
  max: 5,
  maxHearts: 5, // Alias for consistency
  refillIntervalHours: 4,
  refillIntervalMs: 4 * 60 * 60 * 1000, // 4 hours in milliseconds
  practiceToEarnHearts: true,
  heartPracticeQuestionsRequired: 3, // Complete 3 questions to earn 1 heart
};
